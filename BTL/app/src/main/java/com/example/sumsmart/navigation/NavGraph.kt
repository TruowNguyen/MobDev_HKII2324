...
import com.example.sumsmart.ui.GameScreen6
...
sealed class NavGraphItem(val route: String, val titleRes: Int) {
    ...
    object Game6 : NavGraphItem("game6", com.example.sumsmart.R.string.game6_title)
}
...
fun NavGraph(navController: NavHostController) {
    NavHost(navController = navController, startDestination = NavGraphItem.Home.route) {
        ...
        composable(NavGraphItem.Game6.route) { GameScreen6(navController = navController) }
